#ifndef BUFFWR_ITRI_3D_BOUNDING_BOX_H
#define BUFFWR_ITRI_3D_BOUNDING_BOX_H

#include <buffwrBase.hpp>


class buffwrITRI3DBoundingBox: public buffwrBase
{
public:

    buffwrITRI3DBoundingBox(): _buffer(0)
    {
    }
    buffwrITRI3DBoundingBox(size_t buffer_length_in): _buffer(buffer_length_in)
    {
    }
...
private:
    // The buffer
    async_buffer< msgs::LidRoi >  _buffer;
};


#endif // BUFFWR_ITRI_3D_BOUNDING_BOX_H
