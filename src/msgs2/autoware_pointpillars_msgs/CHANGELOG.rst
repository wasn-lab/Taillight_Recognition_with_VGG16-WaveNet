^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package autoware_pointpillars_msgs
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Support old behavior of insert static object for obstacle avoidance testing
  ...
  insert autoware_pointpillars_build_flags to new nodes
...
* Update OpenPlanner libraries (op_planner, op_utitity, op_ros_helpers)
  ...
  Modify autoware_pointpillars_msgs for OpenPlanner use (CloudCluster, DetectedObject, lane, waypoint)
...
* autoware_pointpillars_msgs does not depend on jsk_rviz_plugin, cmake and package.xml were not correct
...
1.3.0 (2017-07-14)
------------------
* convert to autoware_pointpillars_msgs
