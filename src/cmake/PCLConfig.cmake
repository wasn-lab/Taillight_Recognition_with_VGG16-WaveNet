...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-6.2" CACHE PATH "The directory containing VTKConfig.cmake")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-6.2" CACHE PATH "The directory containing VTKConfig.cmake")
    endif()
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/lib/cmake/vtk-6.2" CACHE PATH "The directory containing VTKConfig.cmake")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/garywang/work/pcl")
...
set(pcl_all_components  common kdtree octree search gpu_containers gpu_utils gpu_kinfu gpu_octree gpu_kinfu_large_scale gpu_features gpu_segmentation sample_consensus filters 2d features keypoints registration io geometry visualization outofcore ml recognition segmentation stereo surface cuda_common cuda_sample_consensus cuda_features cuda_segmentation tracking people )
