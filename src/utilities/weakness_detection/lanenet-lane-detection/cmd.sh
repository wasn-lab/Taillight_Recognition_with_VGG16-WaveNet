...
dl_data
python find_lanes.py --weights-path ${lanenet_dir}/bisenet-v2/tusimple_lanenet.ckpt --image-filenames /home/chtseng/repo/itriadv/src/utilities/alexab_darknet/drivenet_dataset/Dataset_Fov_raw/valid.txt
python overlay_lane.py --image-filenames /home/chtseng/repo/itriadv/src/utilities/alexab_darknet/drivenet_dataset/Dataset_Fov_raw/valid.txt
