...
sleep 15
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_control_new.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_wayarea2grid.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_vector_map_loader.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_radar.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_mmtp_new.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_local_planning_new.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_adv_to_server.sh;exec bash"'


sleep 3
gnome-terminal  -e 'ssh -t local "./home/localization/itriadv/src/scripts/local/init_map.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t local "./home/localization/itriadv/src/scripts/local/init_localization.sh;exec bash"'
sleep 3
gnome-terminal  -e 'ssh -t local "./home/localization/itriadv/src/scripts/local/init_localization_supervision.sh;exec bash"'

sleep 3
gnome-terminal  -e 'ssh -t ta "./home/nvidia/itriadv/src/scripts/ta/init_camera.sh;exec bash"'
sleep 3
...
sleep 3
gnome-terminal  -e "ssh -t camera './home/camera/itriadv/src/scripts/camera/init_camera.sh;exec bash'"
sleep 1
