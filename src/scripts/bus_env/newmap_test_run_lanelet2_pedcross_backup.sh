...
sleep 3
gnome-terminal  -e 'bash -c "./init_fail_safe.sh;exec bash"'
...
sleep 3
gnome-terminal  -e 'bash -c "~/init_adv_to_server_lanelet2.sh;exec bash"'
#sleep 3
...
sleep 3
gnome-terminal  -e "ssh -t camera './init_fail_safe.sh;exec bash'"
