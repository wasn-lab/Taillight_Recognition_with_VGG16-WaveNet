...
searchString2="bash /home/nvidia/itriadv/src/scripts/bus_env/xavier/init_camera_driver_for_laboratory_mode.sh"
file="/etc/rc.local"
if [ -f "/etc/rc.local" ]; then    
    ...
    then
            ...
            echo "bash /home/nvidia/itriadv/src/scripts/bus_env/xavier/init_camera_driver_for_laboratory_mode.sh" | sudo tee -a $file  
    fi
