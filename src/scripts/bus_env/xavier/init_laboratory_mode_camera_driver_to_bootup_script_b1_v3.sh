...
searchString2="bash /home/nvidia/itriadv/src/sensing/camera_grabber/src/CameraGrabber/init_ar0231_driver_b1_v3.sh /home/nvidia/itriadv/src/sensing/camera_grabber/src/CameraGrabber nvidia false"
...
if [ -f "/etc/rc.local" ]; then    
    ...
    then
            echo "init_ar0231_driver_b1_v3.sh always in $file"
    else
            ...
            echo "bash /home/nvidia/itriadv/src/sensing/camera_grabber/src/CameraGrabber/init_ar0231_driver_b1_v3.sh /home/nvidia/itriadv/src/sensing/camera_grabber/src/CameraGrabber nvidia false" | sudo tee -a $file  
    fi
