...
searchString2="bash /home/nvidia/itriadv/src/scripts/bus_env_cbus/xavier/init_camera_driver_for_laboratory_mode.sh"
file="/etc/rc.local"
if [ -f "/etc/rc.local" ]; then    
    ...
    then
            ...
            echo "sleep 5"                                   | sudo tee -a $file    
            echo "#init camera driver for laboratory mode"   | sudo tee -a $file
            echo "bash /home/nvidia/itriadv/src/scripts/bus_env_cbus/xavier/init_camera_driver_for_laboratory_mode.sh" | sudo tee -a $file  
    fi
