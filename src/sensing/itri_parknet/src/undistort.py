...
def _init_params():
    ...
    ymlfile = os.path.join(camera_utils_dir, "data", "camera_calibration", "sn_ar0231_gmsl_120h.yml")
    print(os.path.join(camera_utils_dir, "data", "camera_calibration", "sn_ar0231_gmsl_120h.yml"))
