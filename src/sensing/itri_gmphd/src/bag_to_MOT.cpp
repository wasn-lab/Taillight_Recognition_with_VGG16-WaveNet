...
void BagToMOT::cache_crop_image_callback(const sensor_msgs::Image::ConstPtr& msg)
{
#if PRINT_MESSAGE
  ros::Time start;
  start = ros::Time::now();
...
void BagToMOT::pedestrian_event()
{
  ...
  sub_2 = nh_sub_2.subscribe("/cam/front_bottom_60", 1, &BagToMOT::cache_image_callback,
                             this);  // /cam/F_right is sub topic

  sub_5 = nh_sub_3.subscribe("/cam/front_bottom_60_crop", 1, &BagToMOT::cache_crop_image_callback,
                             this);  // /cam/F_center is sub topic

  /*
    sub_1 = nh_sub_1.subscribe("/Tracking2D/left_back_60", 1, &PedestrianEvent::chatter_callback,
                                this);  // /PathPredictionOutput is sub topic
    sub_2 = nh_sub_2.subscribe("/cam/left_back_60", 1, &PedestrianEvent::cache_image_callback,
                                this);  // /cam/F_right is sub topic
    sub_3 = nh_sub_1.subscribe("/nav_path_astar_final", 1, &PedestrianEvent::nav_path_callback,
                                this);  // /cam/F_center is sub topic
    sub_4 = nh_sub_4.subscribe("/veh_info", 1, &PedestrianEvent::veh_info_callback,
                                this);  // /cam/F_center is sub topic
    sub_5 = nh_sub_3.subscribe("/cam/No_High_Resolution", 1, &PedestrianEvent::cache_crop_image_callback,
                                this);  // /cam/F_center is sub topic
    sub_6 = nh_sub_5.subscribe("/PedCross/Pedestrians/left_back_60", 1, &PedestrianEvent::draw_pedestrians_callback,
                                this);  // /cam/F_center is sub topic

    sub_1 = nh_sub_1.subscribe("/Tracking2D/right_back_60", 1, &PedestrianEvent::chatter_callback,
                                this);  // /PathPredictionOutput is sub topic
    ...
    sub_5 = nh_sub_3.subscribe("/cam/No_High_Resolution", 1, &PedestrianEvent::cache_crop_image_callback,
                                this);  // /cam/F_center is sub topic
    sub_6 = nh_sub_5.subscribe("/PedCross/Pedestrians/right_back_60", 1, &PedestrianEvent::draw_pedestrians_callback,
                                this);  // /cam/F_center is sub topic
  */
