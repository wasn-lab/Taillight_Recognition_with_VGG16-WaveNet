...
{         
    // regionHeight_60_FC_x = {1207, 1119, 1045, 987, 940, 908, 873, 846, 822, 802, 780, 763, 748, 738, 728, 682, 650, 630, 615, 600, 590, 400};
    ...
    regionHeight_30_R_x = {1903, 1680, 1530, 1378, 1225, 1112, 1035, 966, 895, 839, 800, 758, 707, 661, 531, 450, 387, 353, 320, 297};
...
float DistanceEstimation::ComputeObjectYDist(int piexl_loc_y, int piexl_loc_x, std::vector<int> regionHeight, std::vector<float> regionHeightSlope_y, std::vector<float> regionDist, int mode)
{
    float distance = -1;
    float unitLength = 0.0;
    int bias = 0;
    ...
    else if (mode == 2)
    {
        ...
        for (int i = 1; i < regionHeight.size(); i++)
        {
            ...
            // std::cout <<  "piexl_loc_x: " << piexl_loc_x << ", y: " << y << "pixel location offset: " << int((1/regionHeightSlope_y[i])*y) << std::endl; 
