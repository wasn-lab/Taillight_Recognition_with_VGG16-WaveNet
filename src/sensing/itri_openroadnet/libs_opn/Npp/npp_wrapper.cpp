...
namespace npp_wrapper
{
  ...
  void npp::init_3(const int ori_cols, const int ori_rows, const double wscale, const double hscale)
  {
    ...
    RGBOrder[0] = 0; RGBOrder[1] = 1; RGBOrder[2] = 2;
  }
            ...
            const NppiInterpolationMode interpolation_mode)
  {
    ...
    const int num_src_bytes = src.cols * src.rows * 1;
            ...
            const NppiInterpolationMode interpolation_mode)
  {
    ...
    NppStatus result;
    result = nppiResize_8u_C3R(src_npp8u_ptr_, src_line_steps, src_size, src_roi, 
                                dst_npp8u_ptr_, dst_line_steps, dst_size, dst_roi, interpolation_mode);
            ...
            const NppiInterpolationMode interpolation_mode)
  {
    ...
    // result = nppiSwapChannels_8u_C3R(rawCUDA_, src_line_steps, src_npp8u_ptr_, src_line_steps, src_size, RGBOrder);  // RGB to BGR of uint in CUDA
    
    // result = nppiSwapChannels_8u_C4C3R(rawCUDA_, src_line_steps, src_npp8u_ptr_, src_line_steps, src_size, RGBOrder);  // RGBA to RGB of uint in CUDA
    ...
    result = nppiResize_8u_C3R(rawCUDA_, src_line_steps, src_size, src_roi, dst_npp8u_ptr_, dst_line_steps,
                                        dst_size, dst_roi, interpolation_mode);
