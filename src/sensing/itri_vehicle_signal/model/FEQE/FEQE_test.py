...
parser.add_argument("--model_path", type=str, default="checkpoint/mse_s2/model.ckpt", help="model path")
...
def main():
    ...
    for i, _ in enumerate(hr_paths):
        ...
        # note that t_lr must be the origin image, not dowmsample result image
        # Also, test.py doesn't need t_hr because it not need to do vgg
