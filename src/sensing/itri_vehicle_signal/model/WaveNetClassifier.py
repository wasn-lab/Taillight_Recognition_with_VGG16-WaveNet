...
class WaveNetClassifier():
  def __init__(self, output_shape, input_shape = None, input_tensor = None, kernel_size = 2, dilation_depth = 9, n_filters = 512, task = 'classification', regression_range = None, load=False, load_dir='./'):
    """
    Parameters:
  ...
  def construct_model(self):  
    ...
    out = Conv1D(self.n_filters, 4, strides = 1, padding='same', name='conv_5ms', activation = 'relu')(out)
    out = AveragePooling1D(4, padding='same', name='downsample_to_200Hz')(out)
