...
parser.add_argument("--saved_model", type=str, default="data/checkpoints/lstm-images.016-1.015.hdf5",
                    help="the path of model")
parser.add_argument("--video_file", type=str, default="utils/flasher.mp4",
...
def save_result_as_csv(result):
    ...
    with open('ncu_dataset_clasify_result_0413.csv', 'a', newline='') as f_object:
