...
def draw_icon(image, pred_str, crop_x, crop_y):
	right_icon = cv.imread('/home/chienminglo/workspace/itriadv/src/sensing/itri_vehicle_signal/scripts/right_arrow_v2_33x29.bmp')
	warning_icon = cv.imread('/home/chienminglo/workspace/itriadv/src/sensing/itri_vehicle_signal/scripts/warning_v2_30x30.bmp')
...
def model_thread(arg):
	...
	#saved_LSTM_model = load_model("/home/chienminglo/workspace/itriadv/src/sensing/itri_vehicle_signal/data/lstm-features.hdf5")
...
def main():
	print("vehicle signal detection is running .. (for test)")

	model_file = rospy.get_param("/vehicle_signal_detection/model_file")
	right_icon = rospy.get_param("/vehicle_signal_detection/right_icon")
	warning_icon = rospy.get_param("/vehicle_signal_detection/warning_icon")

	print('mode_file:', end=' ');print(model_file)
	print('right_icon:', end=' ');print(right_icon)
	print('warning_icon:', end=' ');print(warning_icon)
