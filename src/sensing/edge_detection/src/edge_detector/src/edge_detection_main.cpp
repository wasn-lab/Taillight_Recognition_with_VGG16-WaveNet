...
//grid_map generator
grid_map::GridMap
initializeGridMap(grid_map::GridMap input_grid_map)
{
        ...
        ROS_INFO("Created map with size %f x %f m (%i x %i cells).\n The center of the map is located at (%f, %f) in the %s frame.",
                 tmp_grid_map.getLength().x(), tmp_grid_map.getLength().y(),
                 tmp_grid_map.getSize() (0), tmp_grid_map.getSize() (1),
                 tmp_grid_map.getPosition().x(), tmp_grid_map.getPosition().y(), tmp_grid_map.getFrameId().c_str());
        ...
        *filtered_cloudPtr = hollow_removal (filtered_scan_ptr,-13, 0.7, -2.0, 2.0, -3, 0.5,
        ...
        if (is_FR_grid_new && is_FL_grid_new)
        {
                ...
                if(merged_costmap_.exists("merged_costmap_layer") && merged_costmap_.exists("front_right_points_layer") &&
                   merged_costmap_.exists("front_left_points_layer") && front_right_grid_map_data.exists("front_right_points_layer") &&
                   front_left_grid_map_data.exists("front_left_points_layer"))
                {
                        ...
                        tmp_map["merged_costmap_layer"] = tmp_map["merged_costmap_layer"].cwiseMax(tmp_map_fr["front_right_points_layer"]);
                        ...
                        if (occupancy_grid_publisher.getNumSubscribers() != 0) {
                                ...
                                grid_map::GridMapRosConverter::toOccupancyGrid(merged_costmap_, "merged_costmap_layer", 0, 1, occupancy_grid_msg);
