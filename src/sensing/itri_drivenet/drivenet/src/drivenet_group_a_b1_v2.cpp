...
int main(int argc, char** argv)
{
  ...
  static void (*f_cam_callbacks[])(const sensor_msgs::Image::ConstPtr&) = { callback_cam_front_bottom_60, callback_cam_front_top_far_30 };
  static void (*f_cam_decodes_callbacks[])(sensor_msgs::CompressedImage) = { callback_cam_front_bottom_60_decode, callback_cam_front_top_far_30_decode };
...
msgs::DetectedObject run_dist(ITRI_Bbox box, int cam_order)
{
  ...
  {
    lCheck = g_dist_est.CheckPointInArea(g_dist_est.area[camera::id::front_bottom_60], box.x1, box.y2);
    rCheck = g_dist_est.CheckPointInArea(g_dist_est.area[camera::id::front_bottom_60], box.x2, box.y2);
  }
  else if (g_cam_ids[cam_order] == camera::id::front_top_far_30)
  {
    lCheck = g_dist_est.CheckPointInArea(g_dist_est.area[camera::id::front_top_far_30], box.x1, box.y2);
    rCheck = g_dist_est.CheckPointInArea(g_dist_est.area[camera::id::front_top_far_30], box.x2, box.y2);
  }
