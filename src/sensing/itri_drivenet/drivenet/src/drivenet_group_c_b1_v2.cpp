...
#include "drivenet/drivenet_group_c_b1_v2.h"
...
const std::vector<int> g_cam_ids{ camera::id::left_front, camera::id::left_rear, camera::id::top_rear_120};
#else
...
int main(int argc, char** argv)
{
  ...
  static void (*f_cam_callbacks[])(const sensor_msgs::Image::ConstPtr&) = {callback_cam_0, callback_cam_1, callback_cam_2};
  static void (*f_cam_decodes_callbacks[])(sensor_msgs::CompressedImage) = {callback_cam_0_decode, callback_cam_1_decode, callback_cam_2_decode};
