...
void DistanceEstimation::init(int car_id)
{
  ...
  regionHeightSlope_60_FC_y = {
    0.12, 0.209, 0.27, 0.337, 0.44, 1.02, 3.87, -1.53, -0.66, -0.452, -0.333, -0.251, -0.121
  };
  ...
  regionHeight_120_FT_x = { 1207, 1002, 740, 574, 460, 379, 320, 272, 231, 198, 171,
                            150,  130,  115, 99,  86,  75,  65,  57,  48,  40,  10 };  // Horizontal line
  ...
  regionHeight_120_BT_y = { -1566, -1230, -861, -264, 40, 475, 875, 1370, 1704, 2195, 2439, 2808, 3152 };  // Vertical
                                                                                                           // line
