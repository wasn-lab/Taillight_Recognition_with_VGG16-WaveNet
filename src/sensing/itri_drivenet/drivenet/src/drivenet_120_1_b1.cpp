                    ...
                    int dist_w, int dist_h)
{
  ...
  if (cam_ids_[cam_order] == cam_ids_[3] && !isInferData_3)
  {
    isInferData_3 = true;
    isPushData = true;
  }
...
void callback_120_0(const sensor_msgs::Image::ConstPtr& msg)
{
  ...
  if (isCalibration)
  {
    ...
    if (!isInferData_0)
      sync_inference(0, 5, h, &mat120_0_rect, &vBBX120_0, 1920, 1208);
  }
  else
  {
    if (!isInferData_0)
      sync_inference(0, 5, h, &mat120_0, &vBBX120_0, 1920, 1208);
  }
}
...
void callback_120_1(const sensor_msgs::Image::ConstPtr& msg)
{
  ...
  if (isCalibration)
  {
    ...
    if (!isInferData_1)
      sync_inference(1, 6, h, &mat120_1_rect, &vBBX120_1, 1920, 1208);
  }
  else
  {
    if (!isInferData_1)
      sync_inference(1, 6, h, &mat120_1, &vBBX120_1, 1920, 1208);
  }
}
...
void callback_120_2(const sensor_msgs::Image::ConstPtr& msg)
{
  ...
  if (isCalibration)
  {
    ...
    if (!isInferData_2)
      sync_inference(2, 8, h, &mat120_2_rect, &vBBX120_2, 1920, 1208);
  }
  else
  {
    if (!isInferData_2)
      sync_inference(2, 8, h, &mat120_2, &vBBX120_2, 1920, 1208);
  }
}
...
void callback_120_3(const sensor_msgs::Image::ConstPtr& msg)
{
  ...
  if (isCalibration)
  {
    ...
    if (!isInferData_3)
      sync_inference(3, 9, h, &mat120_3_rect, &vBBX120_3, 1920, 1208);
  }
  else
  {
    if (!isInferData_3)
      sync_inference(3, 9, h, &mat120_3, &vBBX120_3, 1920, 1208);
  }
}
