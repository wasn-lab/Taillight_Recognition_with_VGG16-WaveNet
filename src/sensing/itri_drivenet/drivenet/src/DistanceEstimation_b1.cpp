...
{     
    ...
    regionHeightSlope_60_FC_y = {0.193 ,0.224, 0.304, 0.44, 1.02, 3.87, -1.53, -0.66, -0.452, -0.333, -0.251};
    regionHeight_60_FC_y = {-1099, -509, -112, 242, 608, 913, 1220, 1510, 1746, 2016, 2346};
