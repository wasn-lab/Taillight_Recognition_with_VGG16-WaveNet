...
/// camera layout
#if CAR_MODEL_IS_B1
const std::vector<camera::id> g_cam_ids{ camera::id::front_60, camera::id::top_front_120, 
  camera::id::left_60, camera::id::right_60 };
#else
...
pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZI> g_rgb_cam_top_front_120(g_cam_top_front_120_ptr, 255, 0, 0);
...
void drawPointCloudOnImage()
{
  ...
  std::vector<pcl::PointCloud<pcl::PointXYZI>> cam_points = {*g_cam_front_60_ptr, 
      *g_cam_top_front_120_ptr, *g_cam_left_60_ptr, *g_cam_right_60_ptr};
...
int main(int argc, char** argv)
{
  ...
  static void (*f_callbacks_cam[])(const sensor_msgs::Image::ConstPtr&) = { callback_cam_front_60,
      callback_cam_top_front_120, callback_cam_left_60, callback_cam_right_60 };
  static void (*f_callbacks_cam_decode[])(sensor_msgs::CompressedImage) = { callback_cam_decode_front_60,
      callback_cam_decode_top_front_120, callback_cam_decode_left_60, callback_cam_decode_right_60 };
  static void (*f_callbacks_object[])(const msgs::DetectedObjectArray::ConstPtr&) = { callback_object_cam_front_60,
      callback_object_cam_top_front_120, callback_object_cam_left_60, callback_object_cam_right_60 };
