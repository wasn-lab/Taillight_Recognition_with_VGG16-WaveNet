...
extern "C" void cudaResize_video(float* d_out, int result_width, int result_height, float* d_in, int ori_width,
                                 int ori_height, int N);
extern "C" void cudaResize_gpu_memory_preprocess(float* d_out, int result_width, int result_height, unsigned char* d_in,
