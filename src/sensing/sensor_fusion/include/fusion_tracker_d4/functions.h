...
struct _transmat
{
	double R[9]; double iR[9];
	double t[3];
	double K[9]; double iK[9];
};
...
//void read_lidar(const char *lidar_name, int index_lidar, const char *lidar_type, double** &GNSS, int** &PIXEL, int* &GNSS_refc, int& num_points, transmat_t trans, imagedim_t imgdim);
//=======================================================================
