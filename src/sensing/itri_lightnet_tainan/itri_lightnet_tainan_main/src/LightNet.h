...
#ifdef Tainan
const std::string INPUT_PROTOTXT = "./416/TLS2D_DivU_30deg.prototxt";
const std::string INPUT_CAFFEMODEL = "./416/TLS2D_DivU_30deg_v2.caffemodel";
string mode = "fp16";
RUN_MODE run_mode = RUN_MODE::FLOAT16;
string OUTPUTS= "yolo-det";//layer82-conv,layer94-conv,layer106-conv
string engineName = "./src/sensing/itri_lightnet_tainan/itri_lightnet_tainan_main/resources/LightNet.IPC_fp16_tainan.engine";
unique_ptr<float[]> outputData(new float[100549]);
#endif
...
bool finLightStatus[6];
bool preLightStatus[6];
