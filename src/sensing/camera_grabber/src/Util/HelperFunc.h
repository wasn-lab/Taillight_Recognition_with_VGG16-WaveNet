...
namespace LOGGER{
    ...
    inline void printSpeedInfoSync(float img, float lane, float signal, float drive60, float drive30, float opn, float all, float noGPU_overhead_count = -1){
        //printf("\e[1;1H\e[2J");
        ...
        if(noGPU_overhead_count < 0)
            printf( "Camera Enabled 3 front 60 deg, 3 front 30 deg\n"
                    ...
                    "============================================\n"
                    "\n\n\n", img ,lane, 1000.0f / lane , signal, 1000.0f / signal ,
                      drive60, 1000.0f / drive60, drive30, 1000.0f / drive30, opn, 1000.0f / opn ,all, 1000.0f / all);
        //Apear in demo mode
        else
            printf( "Camera Enabled 3 front 60 deg, 3 front 30 deg\n"
                    "Modules run \"synchronously\":\n"
                    ...
                    "============================================\n"
                    "\n\n\n", img ,lane, 1000.0f / lane , signal, 1000.0f / signal ,
                      drive60, 1000.0f / drive60, drive30, 1000.0f / drive30, opn, 1000.0f / opn, noGPU_overhead_count ,all, 1000.0f / all);         
    }
