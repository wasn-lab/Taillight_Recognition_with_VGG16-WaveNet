...
def main():
    ...
    if args.eval_every is not None:
        ...
        print("Loaded evaluation data from {eval_data_path}")
...
#         print('hyperparams')
#         print(node_type)
#         print(trajectron.node_models_dict[node_type].hyperparams)
#     print('node models dict')
#     print(trajectron.node_models_dict[train_env.NodeType[0]].hyperparams)
