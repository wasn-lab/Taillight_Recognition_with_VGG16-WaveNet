...
class Scene(object):
    def __init__(self, timesteps, map=None, dt=1, name="", frequency_multiplier=1, aug_func=None,  non_aug_scene=None, x_min=None, y_min=None, x_max=None, y_max=None):
        self.map = map
    ...
    def present_nodes(self,
        ...
        for node in self.nodes:
            ...
            if type is None or node.type == type:
                ...
                # print 'first_timestep: ',node.first_timestep,'last_timestep: ',node.last_timestep
        ...
        assert isinstance(present_nodes,dict) 
