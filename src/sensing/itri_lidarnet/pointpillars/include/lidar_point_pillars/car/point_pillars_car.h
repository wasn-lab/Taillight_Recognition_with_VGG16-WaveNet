...
#ifndef POINTS_PILLAR_CAR_H
#define POINTS_PILLAR_CAR_H
...
#include "lidar_point_pillars/common/common.h"
#include "lidar_point_pillars/car/preprocess_points_car.h"
#include "lidar_point_pillars/car/preprocess_points_cuda_car.h"
#include "lidar_point_pillars/common/anchor_mask_cuda.h"
#include "lidar_point_pillars/common/scatter_cuda.h"
#include "lidar_point_pillars/car/postprocess_cuda_car.h"
...
public:
  ...
  */
  PointPillars_Car(const bool reproduce_result_mode, const float score_threshold, const float nms_overlap_threshold,
  ...
  */
  void doInference(const float* in_points_array, const int in_num_points, std::vector<float>& out_detections,std::vector<float>& out_scores);
};
