...
#ifndef POINTS_PILLAR_PED_CYC_H
#define POINTS_PILLAR_PED_CYC_H
...
#include "lidar_point_pillars/ped_cyc/preprocess_points_cuda_ped_cyc.h"
...
public:
  ...
  */
  PointPillars_Ped_Cyc(const bool reproduce_result_mode, const float score_threshold, const float nms_overlap_threshold,
               const std::string pfe_onnx_file, const std::string rpn_onnx_file);
  ~PointPillars_Ped_Cyc();
