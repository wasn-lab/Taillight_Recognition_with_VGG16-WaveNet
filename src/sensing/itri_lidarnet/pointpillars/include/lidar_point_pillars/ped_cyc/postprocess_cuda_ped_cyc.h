...
#ifndef POSTPROCESS_CUDA_PED_CYC_H
#define POSTPROCESS_CUDA_PED_CYC_H
...
#include "lidar_point_pillars/common/nms_cuda.h"
...
public:
  ...
  */
  void doPostprocessCuda(const float* rpn_box_output, const float* rpn_cls_output, const float* rpn_dir_output,
                         ...
                         int* dev_filter_count, std::vector<int>& out_label, std::vector<float>& out_detection);
};
