...
#include "lidar_point_pillars/car/point_pillars_car.h"

// clang-format off
PointPillars_Car::PointPillars_Car(const bool reproduce_result_mode, const float score_threshold,
...
PointPillars_Car::~PointPillars_Car()
{
  delete[] anchors_px_;
  delete[] anchors_py_;
  delete[] anchors_pz_;
...
void PointPillars_Car::deviceMemoryMalloc()
{
  // clang-format off
...
void PointPillars_Car::initAnchors()
{
...
void PointPillars_Car::generateAnchors(float* anchors_px_, float* anchors_py_, float* anchors_pz_, float* anchors_dx_,
...
void PointPillars_Car::putAnchorsInDeviceMemory()
{
  // clang-format off
...
void PointPillars_Car::convertAnchors2BoxAnchors(float* anchors_px, float* anchors_py, float* anchors_dx, float* anchors_dy,
...
void PointPillars_Car::onnxToTRTModel(const std::string& model_file,             // name of the onnx model
...
void PointPillars_Car::preprocessCPU(const float* in_points_array, const int in_num_points)
{
...
void PointPillars_Car::preprocessGPU(const float* in_points_array, const int in_num_points)
{
  float* dev_points;
  // clang-format off
...
void PointPillars_Car::preprocess(const float* in_points_array, const int in_num_points)
{
  if (reproduce_result_mode_)
  {
