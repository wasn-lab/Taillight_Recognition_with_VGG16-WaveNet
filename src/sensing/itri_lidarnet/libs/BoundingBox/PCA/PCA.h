...
public:
  ...
  void compute(std::vector<pcl::PointXYZ>& out_cube, pcl::PointXYZ& out_centroid, Eigen::Matrix3f& covariance,
               pcl::PointXYZ& out_minPoint, pcl::PointXYZ& out_maxPoint);
  void compute2(std::vector<pcl::PointXYZ>& out_cube, pcl::PointXYZ& out_centroid);
