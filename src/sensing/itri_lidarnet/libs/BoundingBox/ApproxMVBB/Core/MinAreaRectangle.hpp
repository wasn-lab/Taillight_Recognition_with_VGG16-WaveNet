 ...
 */
     ...
     */
        ...
        struct Box2d
        {
            ...
            Vector2 m_p;  ///< first corner x = m_p0 + m_u*m_uL * u + m_v*m_vL * v  , u,v
                          /// in [0,1]
        ...
        inline const Box2d& getMinRectangle()
        {
            return m_minBox;
        }
        ...
        inline std::vector<unsigned int>& getConvexHull2D()
		{
        	return m_convh.getIndices();
		}
    private:
        ...
        // determine caliper angles according to the box given with c[0].m_currAngle =
        // edgeAngle;
        ...
        // determine the vertex v for which the edge angle is greater than
        // c.m_currAngle
