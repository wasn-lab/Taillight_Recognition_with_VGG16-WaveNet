...
#include "Common/FloatingPointComparision.hpp"
#include "Common/TypeDefsPoints.hpp"
#include "Diameter/EstimateDiameter.hpp"
#include "GeometryPredicates/Predicates.hpp"
...
namespace ApproxMVBB
{
    namespace PointFunctions
    {
            ...
            -> std::pair<VectorStat<Dimension>, VectorStat<Dimension>>
        {
            ...
            //ApproxMVBB_MSGLOG_L2("p1: " << p1.transpose() << std::endl<< "p2: " << p2.transpose() << std::endl << " l: " << std::sqrt(pairP.squareDiameter) << std::endl);
