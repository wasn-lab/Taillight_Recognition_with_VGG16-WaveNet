 ...
 */
    ...
    */
    ...
    private:
        ...
        inline void _VerboseWhenReducing()
        {
            _verbose_when_reducing_ = 1;
        }
        inline void _NoVerboseWhenReducing()
        {
            _verbose_when_reducing_ = 0;
        }
        inline int _GetVerboseWhenReducing()
        {
        ...
        inline int _GetReductionModeInIterative()
        {
     ...
     */
        ...
        inline int _GetReductionModeOfDbleNorm()
        {
     ...
     */
        ...
        inline void _DoTryToReduceQ()
        {
            _try_to_reduce_Q_ = 1;
        }
        inline void _DoNotTryToReduceQ()
        {
            _try_to_reduce_Q_ = 0;
        }
        inline int _GetTryToReduceQ()
        {
            return _try_to_reduce_Q_;
        }

        int _Q_scan_ = 0;
        inline void _SetQscanToForward()
        {
            _Q_scan_ = 1;
        }
        inline void _SetQscanToBackward()
        {
            _Q_scan_ = 0;
        }
        inline int _GetQscan()
        {
            return _Q_scan_;
        }

        int _tight_bounds_ = 0;
        inline void _DoTryToGetTightBounds()
        {
            _tight_bounds_ = 1;
        }
        inline void _DoNotTryToGetTightBounds()
        {
            _tight_bounds_ = 0;
        }
        inline int _GetTightBounds()
        {
