...
int _LastPointOutsideSphereWithDiameter(TypeSegment* theSeg, const double squareDiameter, const double** theList,
                                        const int first, int* last, const int dim, const int _reduction_mode_)
{
  int i;
  int index = first - 1;
  int l = *last;
...
int _LastPointOutsideSphereAndBoundWithDiameter(TypeSegment* theSeg, const double squareDiameter,
                                                const double** theList, const int first, int* last, const int dim,
                                                const int _reduction_mode_, double* bound)
{
  int i;
  int index = first - 1;
  int l = *last;
...
*/
  ...
  if (squareDiameter <= theSeg->squareDiameter)
  {
    ...
    return (_LastPointOutsideSphereWithDiameter(theSeg, squareDiameter, theList, first, last, dim, _reduction_mode_));
  }
  else
  {
    minThreshold = (R - .86602540378443864676 * ab) * (R - .86602540378443864676 * ab) - 0.25 * ab2;
...
int _FarthestPointFromSphere(TypeSegment* theSeg, const double** theList, const int first, int* last, const int dim,
...
double _MaximalSegmentInTwoLists(TypeSegment* theSeg, const int index1, const double** theList1, int* first1,
                                 int* last1, const double** theList2, int* first2, int* last2, int dim)
{
  int f1 = *first1;
  int l1 = *last1;
...
double _MaximalSegmentInOneList(TypeSegment* theSeg, const int index, const double** theList, int* first, int* last,
                                const int dim)
{
  int f = *first;
  int l = *last;
...
double _MaximalDistanceFromPoint(int* index, const double* ref, const double** theList, const int first, const int last,
                                 const int dim)
{
  int f = first;
  int l = last;
...
double _QuadraticDiameterInOneList(TypeSegment* theDiam, const double** theList, const int first, const int last,
                                   const int dim)
{
  int i, j;
  double d;
...
double _QuadraticDiameterInTwoLists(TypeSegment* theDiam, int* index1, int* index2, const double** theList1,
                                    const int first1, const int last1, const double** theList2, const int first2,
                                    const int last2, const int dim)
{
  int i, j;
  double d;
