...
{
  m_q_KI.normalize();
  m_minPoint = Vector3(std::min(minPoint(0), maxPoint(0)), std::min(minPoint(1), maxPoint(1)),
                       std::min(minPoint(2), maxPoint(2)));
  m_maxPoint = Vector3(std::max(minPoint(0), maxPoint(0)), std::max(minPoint(1), maxPoint(1)),
                       std::max(minPoint(2), maxPoint(2)));
}
