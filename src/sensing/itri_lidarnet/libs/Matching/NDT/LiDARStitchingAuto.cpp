...
LiDARStitchingAuto::LiDARStitchingAuto() : initialized_(false)
{
    ...
    x_=0; y_=0; z_=0; rx_=0; ry_=0; rz_=0;
    icp_epsilon_=0 ;
    icp_Distance_=0 ;
...
void
LiDARStitchingAuto::coFilter (const boost::shared_ptr<pcl::PointCloud<PointT> > &input_cloud,
...
void LiDARStitchingAuto::pairOmpNDT (
...
)
{
    ...
    std::cout << "has converged first time:" << ndt_omp->getFinalNumIteration() << " score: " << ndt_omp->getFitnessScore() << std::endl;
