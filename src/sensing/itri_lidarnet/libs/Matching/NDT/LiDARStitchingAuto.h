...
class LiDARStitchingAuto{
  public:
    ...
    void
    coFilter (const boost::shared_ptr<pcl::PointCloud<PointT> > &input_cloud,
    ...
    inline void
    getFinalTransform (Eigen::Matrix4f &final_transform)
    {
        final_transform = final_transform_;
    };

    inline void
    setInitTransform (Eigen::Matrix4f init_guess)
    {
    ...
    inline void
    setInitTransform (float x, float y, float z, float rx, float ry, float rz)
    {
    ...
    inline void
    getAlignNormalClouds (pcl::PointCloud<pcl::PointXYZI>::Ptr& src,
                    pcl::PointCloud<pcl::PointXYZI>::Ptr& trg,
    ...
    inline void
    getAlignClouds (pcl::PointCloud<pcl::PointXYZI>::Ptr& src,
                    pcl::PointCloud<pcl::PointXYZI>::Ptr& trg,
