...
public:
  ...
  int send_obj_to_vcu(CLUSTER_INFO* cluster_info, int cluster_size);

  int send_obj_to_server(CLUSTER_INFO* cluster_info, int cluster_size);
  int send_obj_to_rsu(CLUSTER_INFO* cluster_info, int cluster_size);
