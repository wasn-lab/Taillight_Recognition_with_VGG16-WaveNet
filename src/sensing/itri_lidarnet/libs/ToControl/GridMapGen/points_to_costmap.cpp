...
void
PointsToCostmap::initGridmapParam (const grid_map::GridMap& gridmap)
{
...
bool
PointsToCostmap::isValidInd (const grid_map::Index& grid_ind)
{
  bool is_valid = false;
...
grid_map::Index
PointsToCostmap::fetchGridIndexFromPoint (const PointT& point)
{
...
PointsToCostmap::assignPoints2GridCell (const grid_map::GridMap& gridmap,
...
grid_map::Matrix
PointsToCostmap::calculateCostmap (const double maximum_height_thres,
...
template <typename PointT>
grid_map::Matrix
PointsToCostmap::makeCostmapFromSensorPoints (const double maximum_height_thres,
                                              const double minimum_lidar_height_thres,
                                              const double grid_min_value,
                                              const double grid_max_value,
                                              const grid_map::GridMap& gridmap,
                                              ...
                                              const typename pcl::PointCloud<PointT>::Ptr& in_sensor_points)
{
  ...
  grid_map::Matrix costmap = calculateCostmap (maximum_height_thres, minimum_lidar_height_thres, grid_min_value, grid_max_value, gridmap, gridmap_layer_name,
                                               grid_vec);
  return costmap;
}
...
template <typename PointT>
grid_map::GridMap
PointsToCostmap::makeGridMap (const typename pcl::PointCloud<PointT>::Ptr& input)
{
...
template
grid_map::Index
PointsToCostmap::fetchGridIndexFromPoint<PointXYZ> (const PointXYZ& point);

template
grid_map::Index
PointsToCostmap::fetchGridIndexFromPoint<PointXYZIL> (const PointXYZIL& point);

template
std::vector<std::vector<std::vector<double>>>
PointsToCostmap::assignPoints2GridCell<PointXYZ> (const grid_map::GridMap& gridmap,
                                                  const pcl::PointCloud<PointXYZ>::Ptr& in_sensor_points);

template
std::vector<std::vector<std::vector<double>>>
PointsToCostmap::assignPoints2GridCell<PointXYZIL> (const grid_map::GridMap& gridmap,
                                                    const pcl::PointCloud<PointXYZIL>::Ptr& in_sensor_points);

template
grid_map::Matrix
PointsToCostmap::makeCostmapFromSensorPoints<PointXYZ> (const double maximum_height_thres,
                                                        const double minimum_lidar_height_thres,
                                                        const double grid_min_value,
                                                        const double grid_max_value,
                                                        const grid_map::GridMap& gridmap,
...
template
grid_map::Matrix
PointsToCostmap::makeCostmapFromSensorPoints<PointXYZIL> (const double maximum_height_thres,
                                                          const double minimum_lidar_height_thres,
                                                          const double grid_min_value,
                                                          const double grid_max_value,
                                                          const grid_map::GridMap& gridmap,
...
template
grid_map::GridMap
PointsToCostmap::makeGridMap<PointXYZ> (const pcl::PointCloud<PointXYZ>::Ptr& input);

template
grid_map::GridMap
PointsToCostmap::makeGridMap<PointXYZIL> (const pcl::PointCloud<PointXYZIL>::Ptr& input);
