...
PlaneGroundFilter::getCoefficientsSAC (const PointCloud<PointXYZ>::ConstPtr input_cloud,
                            float high)
{
...
pcl::ModelCoefficients
PlaneGroundFilter::getCoefficientsRANSAC (const PointCloud<PointXYZ>::ConstPtr input_cloud,
                            float high)
{
...
PointCloud<PointXYZ>
PlaneGroundFilter::runCoefficients (PointCloud<PointXYZ>::Ptr input,
               float a,
               float b,
               float c,
               float d)
...
pcl::PointIndices
PlaneGroundFilter::runSAC (const PointCloud<PointXYZ>::ConstPtr input_cloud)
{
  pcl::PointIndices output;
...
pcl::PointIndices
PlaneGroundFilter::runSampleConsensusModel (const PointCloud<PointXYZ>::ConstPtr input_cloud)
{
  pcl::PointIndices output;
  pcl::SampleConsensusModelPlane<PointXYZ>::Ptr model_1 (new pcl::SampleConsensusModelPlane<PointXYZ> (input_cloud));
  pcl::RandomSampleConsensus<PointXYZ> ransac (model_1);
...
pcl::PointIndices
PlaneGroundFilter::runMorphological (const typename PointCloud<PointT>::ConstPtr input,
                                                     float setCellSize,
                                                     float setBase,
...
template
pcl::PointIndices
PlaneGroundFilter::runMorphological<PointXYZ> (const typename PointCloud<PointXYZ>::ConstPtr input,
                                                     float setCellSize,
                                                     float setBase,
                                                     int setMaxWindowSize,
                                                     float setSlope,
...
template
pcl::PointIndices
PlaneGroundFilter::runMorphological<PointXYZI> (const typename PointCloud<PointXYZI>::ConstPtr input,
                                                     float setCellSize,
                                                     float setBase,
                                                     int setMaxWindowSize,
                                                     float setSlope,
