...
PointCloud<PointT>
CuboidFilter::pass_through_soild (typename PointCloud<PointT>::Ptr input,
                    float Xmin,
                    float Xmax,
                    float Ymin,
                    float Ymax,
                    ...
                    float Zmax)
{
  ...
  {
    if ( (buff.points[i].x > Xmin && buff.points[i].x < Xmax && buff.points[i].y > Ymin && buff.points[i].y < Ymax && buff.points[i].z > Zmin
        && buff.points[i].z < Zmax))
    {
...
template
PointCloud<PointXYZ>
CuboidFilter::pass_through_soild<PointXYZ> (typename PointCloud<PointXYZ>::Ptr input,
                    float Xmin,
                    float Xmax,
                    float Ymin,
                    float Ymax,
...
CuboidFilter::pass_through_soild<PointXYZI> (typename PointCloud<PointXYZI>::Ptr input,
                    float Xmin,
                    float Xmax,
                    float Ymin,
                    float Ymax,
...
template <typename PointT>
PointCloud<PointT>
CuboidFilter::hollow_removal (typename PointCloud<PointT>::Ptr input,
                double Xmin,
                double Xmax,
                double Ymin,
                double Ymax,
...
template
PointCloud<PointXYZ>
CuboidFilter::hollow_removal<PointXYZ> (typename PointCloud<PointXYZ>::Ptr input,
                double Xmin,
                double Xmax,
                double Ymin,
                double Ymax,
...
template
PointCloud<PointXYZI>
CuboidFilter::hollow_removal<PointXYZI> (typename PointCloud<PointXYZI>::Ptr input,
                double Xmin,
                double Xmax,
                double Ymin,
                double Ymax,
                ...
                float Zmax)
{
  ...
  {
    if (input->points[i].x > Xmin && input->points[i].x < Xmax && input->points[i].y > Ymin && input->points[i].y < Ymax && input->points[i].z > Zmin
        && input->points[i].z < Zmax)
    {
                    ...
                    const PointCloud<PointXYZ>::ConstPtr base)
{
  ...
  pcl::octree::OctreePointCloudChangeDetector<PointXYZ> opccd (0.5f);  // Octree resolution - side length of octree voxels
