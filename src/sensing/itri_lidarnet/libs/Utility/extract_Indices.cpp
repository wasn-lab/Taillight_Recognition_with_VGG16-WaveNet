...
template void extract_Indices<PointXYZ>(const typename PointCloud<PointXYZ>::ConstPtr input_cloud,
                                        const pcl::PointIndicesConstPtr input_Indices,
                                        PointCloud<PointXYZ>& output_inlier, PointCloud<PointXYZ>& output_outlier);

template void extract_Indices<PointXYZI>(const typename PointCloud<PointXYZI>::ConstPtr input_cloud,
                                         const pcl::PointIndicesConstPtr input_Indices,
                                         PointCloud<PointXYZI>& output_inlier, PointCloud<PointXYZI>& output_outlier);

template void extract_Indices<PointXYZIL>(const typename PointCloud<PointXYZIL>::ConstPtr input_cloud,
                                          const pcl::PointIndicesConstPtr input_Indices,
