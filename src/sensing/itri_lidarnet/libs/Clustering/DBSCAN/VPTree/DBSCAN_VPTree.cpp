...
void
DBSCAN_VPTree::setInputCloud (const PointCloud<PointXYZ>::ConstPtr Input)
{
  input = Input;
...
void
DBSCAN_VPTree::setEpsilon (const double Epsilon)
{
  epsilon = Epsilon;
}
void
DBSCAN_VPTree::setMinpts (const unsigned int MinPts)
{
  minpts = MinPts;
}

void
DBSCAN_VPTree::segment (IndicesClusters &index)
{
  dbs->fit ();
