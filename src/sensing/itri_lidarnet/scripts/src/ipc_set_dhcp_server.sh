...
sudo bash -c "echo 'dhcp-range=192.168.0.50,192.168.0.225,255.255.255.0,12h' >> /etc/dnsmasq.d/dhcp.conf"
sudo bash -c "echo '' >> /etc/dnsmasq.d/dhcp.conf"
...
#bc:0f:a7:00:05:f2
#sudo bash -c "echo 'dhcp-host=bc:0f:a7:00:05:f2,os1-991925000304,192.168.0.221,infinite' >> /etc/dnsmasq.d/dhcp.conf"	
#bc:0f:a7:00:11:ba
sudo bash -c "echo 'dhcp-host=bc:0f:a7:00:11:ba,os1-991941000026,192.168.0.221,infinite' >> /etc/dnsmasq.d/dhcp.conf"
#bc:0f:a7:00:0d:ad
sudo bash -c "echo 'dhcp-host=bc:0f:a7:00:0d:ad,os1-991940000164,192.168.0.222,infinite' >> /etc/dnsmasq.d/dhcp.conf"	
#bc:0f:a7:00:11:26
sudo bash -c "echo 'dhcp-host=bc:0f:a7:00:11:26,os1-991940000799,192.168.0.223,infinite' >> /etc/dnsmasq.d/dhcp.conf"
