...
S3Classify::S3Classify() : viewer(NULL), viewID(NULL)
{
}

S3Classify::S3Classify(boost::shared_ptr<pcl::visualization::PCLVisualizer> input_viewer, int* input_viewID)
...
void S3Classify::update(bool is_debug, CLUSTER_INFO* cluster_info, int cluster_size)
{
