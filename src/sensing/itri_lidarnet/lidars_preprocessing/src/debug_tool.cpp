...
void
show_cloud (PointCloud<PointXYZI>::ConstPtr cloud)
{
  ...
  if (flag)
  {
    ...
    cam = CompressFunction().CamPara(-15.847,3.736,69.862,0.899,0.026,0.437,12.458,1.537,11.760,48.793,105.344,0.857,0.857,0.000,0.000,358.000,1028.000);
...
void
show_cloud (PointCloud<PointXYZ>::ConstPtr cloud)
{
  static bool flag = true;
  static int ID = 0;
  static boost::shared_ptr<pcl::visualization::PCLVisualizer> viewer (new pcl::visualization::PCLVisualizer ("3D Viewer"));
...
void
show_cloud (PointCloud<PointNormal>::ConstPtr cloud)
{
  static bool flag = true;
  static int ID = 0;
  static boost::shared_ptr<pcl::visualization::PCLVisualizer> viewer (new pcl::visualization::PCLVisualizer ("3D Viewer"));
  ...
  if (flag)
  {
    ...
    pcl::visualization::Camera cam;
    cam = CompressFunction().CamPara (1.001, -12.307, 28.940, -0.016, 0.739, 0.673, 1.414, 8.011, 6.644, 0.112, 111.772, 0.857, 0.857, 0.000, 0.000, 1000.000, 500.000);
...
void
show_cloud (PointCloud<PointXYZRGB>::ConstPtr cloud)
{
  ...
  cam = CompressFunction().CamPara (1.85068e+09, -2.31115e+10, 1.96841e+10, -0.00150261, 0.648329, 0.761359, 1.00316, -1.04158, 1.44827, 3.01101e+10, 3.08705e+10, 1.74533e-10,
                 1.74533e-10, 0, 0, 960, 540);
...
type_XYZRGB_Normal (PointCloud<PointXYZRGB>::ConstPtr cloud,
...
boost::shared_ptr<pcl::visualization::PCLVisualizer>
type_XYZ_Normal (PointCloud<PointXYZ>::ConstPtr cloud,
                 PointCloud<pcl::Normal>::ConstPtr normals)
{
  boost::shared_ptr<pcl::visualization::PCLVisualizer> viewer (new pcl::visualization::PCLVisualizer ("3D Viewer"));
  viewer->setBackgroundColor (0, 0, 0);
...
void
log_3D (CLUSTER_INFO* cluster_info,
        int cluster_size)
{
...
void
log_2D (CLUSTER_INFO* cluster_info,
        int cluster_size)
{
  timeval curTime;
