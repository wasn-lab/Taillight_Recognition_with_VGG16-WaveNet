    ...
    ui (new Ui::QtViewer)
{
  ...
  if (ros::param::has("LaunchFileName"))
  {
      ...
      srcfile = "../../../src/launch/launch/" + QString::fromStdString(LaunchFileName);
      ...
      else if (LaunchFileName == "b1.launch")
      {
...
void QtViewer::on_Btn_Left_Save_clicked()
{
    ...
    .arg(GlobalVariable::UI_PARA[0]).arg(GlobalVariable::UI_PARA[1])
    .arg(GlobalVariable::UI_PARA[2]).arg(GlobalVariable::UI_PARA[3])
    .arg(GlobalVariable::UI_PARA[4]).arg(GlobalVariable::UI_PARA[5]);
...
void QtViewer::on_Btn_Right_Save_clicked()
{
    ...
    .arg(GlobalVariable::UI_PARA[6]).arg(GlobalVariable::UI_PARA[7])
    .arg(GlobalVariable::UI_PARA[8]).arg(GlobalVariable::UI_PARA[9])
    .arg(GlobalVariable::UI_PARA[10]).arg(GlobalVariable::UI_PARA[11]);
...
void QtViewer::on_Btn_Front_Save_clicked()
{
    ...
    .arg(GlobalVariable::UI_PARA[12]).arg(GlobalVariable::UI_PARA[13])
    .arg(GlobalVariable::UI_PARA[14]).arg(GlobalVariable::UI_PARA[15])
    .arg(GlobalVariable::UI_PARA[16]).arg(GlobalVariable::UI_PARA[17]);
...
void QtViewer::on_Btn_RearRight_Save_clicked()
{
    ...
    .arg(GlobalVariable::UI_PARA[18]).arg(GlobalVariable::UI_PARA[19])
    .arg(GlobalVariable::UI_PARA[20]).arg(GlobalVariable::UI_PARA[21])
    .arg(GlobalVariable::UI_PARA[22]).arg(GlobalVariable::UI_PARA[23]);
