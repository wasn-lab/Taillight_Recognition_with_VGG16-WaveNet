...
void
ssn_v2_nodelet::LidarsNodelet::onInit()
{
  ros::NodeHandle nh;
...
void 
ssn_v2_nodelet::LidarsNodelet::callback_LidarAll(const pcl::PointCloud<pcl::PointXYZI>::ConstPtr& msg)
{
...
bool
ssn_v2_nodelet::LidarsNodelet::to_bool(std::string const& s)
{
  return s != "0";
}
