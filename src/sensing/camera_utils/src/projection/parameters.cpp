...
CalibrateParameters::CalibrateParameters(double t_x, double t_y, double t_z, double d_x, double d_y, double d_z, unsigned int f, unsigned int u, unsigned int v, string t, string o_t)
{
  t_x_double_ = t_x;
  t_y_double_ = t_y;
  t_z_double_ = t_z;
