...
class CalibrateParameters
{
  ...
  public:
      //constructor
      CalibrateParameters();
      CalibrateParameters(double t_x, double t_y, double t_z, double d_x, double d_y, double d_z, unsigned int f, unsigned int u, unsigned int v,string t, string o_t);
      ~CalibrateParameters();
