...
class Node:
    ...
    def __init__(self):
        ...
        # Publishers
        self.track3d_aw_pub = rospy.Publisher("/Tracking3D_aw", DynamicObjectArray, queue_size=1)
        # Subscribers
        self.track3d_sub = rospy.Subscriber("/Tracking3D", DetectedObjectArray, self.track3d_callback)
    ...
    def msg_convert(self, in_list)
        ...
        for in_obj in in_list.objects:
            ...
            out_obj.state.pose_covariance.pose.position.x = (in_obj.bPoint.b0.x + in_obj.bPoint.b7.x) / 2
            out_obj.state.pose_covariance.pose.position.y = (in_obj.bPoint.b0.y + in_obj.bPoint.b7.y) / 2
            out_obj.state.pose_covariance.pose.position.z = (in_obj.bPoint.b0.z + in_obj.bPoint.b7.z) / 2
