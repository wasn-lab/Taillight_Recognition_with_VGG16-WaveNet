...
void untitled1ModelClass::step()
{
  ...
  for (b_i = 0; b_i < (int32_T)rtU.Input3; b_i++)
  {
    ...
    Object_X[4] = (((rtU.Input2[i - 1] + rtU.Input2[i + 199]) + rtU.Input2[i + 399]) + rtU.Input2[i + 599]) / 4.0;
    i = (int32_T)t;
    ...
    Object_Y[4] = (((rtU.Input2[i - 1] + rtU.Input2[i + 199]) + rtU.Input2[i + 399]) + rtU.Input2[i + 599]) / 4.0;
    i = 0;
