...
void chatterCallback1(const msgs::DetectedObjectArray::ConstPtr& msg)
{
  ...
  for (int i = 0; i < size; i++)
  {
    ...
    ABS_BB[2 * i + 200] =
        cos(Heading) * rtObj.rtU.Input2[2 * i + 200] - sin(Heading) * rtObj.rtU.Input2[2 * i + 201] + SLAM_x;
    ABS_BB[2 * i + 201] =
        sin(Heading) * rtObj.rtU.Input2[2 * i + 200] + cos(Heading) * rtObj.rtU.Input2[2 * i + 201] + SLAM_y;
    ABS_BB[2 * i + 400] =
        cos(Heading) * rtObj.rtU.Input2[2 * i + 400] - sin(Heading) * rtObj.rtU.Input2[2 * i + 401] + SLAM_x;
    ABS_BB[2 * i + 401] =
        sin(Heading) * rtObj.rtU.Input2[2 * i + 400] + cos(Heading) * rtObj.rtU.Input2[2 * i + 401] + SLAM_y;
    ABS_BB[2 * i + 600] =
        cos(Heading) * rtObj.rtU.Input2[2 * i + 600] - sin(Heading) * rtObj.rtU.Input2[2 * i + 601] + SLAM_x;
    ABS_BB[2 * i + 601] =
        sin(Heading) * rtObj.rtU.Input2[2 * i + 600] + cos(Heading) * rtObj.rtU.Input2[2 * i + 601] + SLAM_y;
    for (int i = 0; i < 400; i++)
    {
