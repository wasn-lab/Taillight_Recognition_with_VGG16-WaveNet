...
void createLocalPointMarker_1(const autoware_msgs::Lane& lane_waypoint)
{
  visualization_msgs::Marker lane_waypoint_marker;
  lane_waypoint_marker.header.frame_id = "map";
  lane_waypoint_marker.header.stamp = ros::Time::now();
  lane_waypoint_marker.ns = "local_point_marker_1";
  lane_waypoint_marker.id = 0;
  lane_waypoint_marker.type = visualization_msgs::Marker::SPHERE_LIST;
  lane_waypoint_marker.action = visualization_msgs::Marker::ADD;
  lane_waypoint_marker.scale.x = 2.4;
  lane_waypoint_marker.scale.y = 2.4;
  lane_waypoint_marker.scale.z = 2.4;
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber final_sub = nh.subscribe("safety_waypoints", 10, finalCallback);
