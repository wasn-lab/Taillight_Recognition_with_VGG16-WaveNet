...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE_e;          // '<S2>/Unit Delay1'
  ...
  boolean_T LastPath_not_empty;        // '<S2>/DynamicPathPlanning'
} DW;
...
//  '<S22>'  : 'MM_TP/Target_planner/MM'
//  '<S23>'  : 'MM_TP/Target_planner/Steer_gain_scheduling'
//  '<S24>'  : 'MM_TP/Target_planner/Target_Point_seg_info1'
//  '<S25>'  : 'MM_TP/Target_planner/trajectory merge'
