...
// C/C++ source code generated on : Thu Nov 14 18:03:02 2019
//
...
void MM_DPP_1ModelClass::step()
{
  ...
  real_T rtb_final_takeoverlength;
  ...
  int32_T forward_length_0;
  int32_T forward_length_1;
  ...
  if (rtb_Add > 0.0) {
    ...
    do {
      ...
      if (settled[b_ix] == 0) {
        ...
        if (idx <= 2) {
          if (idx == 1) {
            OB_enlargescale = table[ii_data_0[0] + 187];
          } else if (table[ii_data_0[0] + 187] > table[ii_data_0[1] + 187]) {
            OB_enlargescale = table[ii_data_0[1] + 187];
          ...
          if (b_idx == 0) {
            ...
            OB_enlargescale = table[ii_data_0[b_idx - 1] + 187];
            while (b_idx + 1 <= idx) {
              if (OB_enlargescale > table[ii_data_0[b_idx] + 187]) {
                OB_enlargescale = table[ii_data_0[b_idx] + 187];
              }
        ...
        for (iy = 0; iy < idx; iy++) {
          x_data[iy] = (table[ii_data_0[iy] + 187] == OB_enlargescale);
        }
  ...
  for (ix = 0; ix < 188; ix++) {
    if (rtConstP.pooled2[940 + ix] == (rtInf)) {
      ...
      rtb_Forward_length_final = rtConstP.pooled2[940 + ix] - rtb_Gain1;
      table[ix] = (b_j - rtConstP.pooled2[1128 + ix]) / rtb_Forward_length_final;
      table[188 + ix] = (rtConstP.pooled2[940 + ix] * b_j - rtConstP.pooled2
                         [1128 + ix] * rtb_Gain1) / rtb_Forward_length_final;
    }

    OB_enlargescale = table[ix] - rtb_X[0];
    offset_4 = table[188 + ix] - rtb_X[1];
  ...
  MM(rtb_X[2] * 180.0 / 3.1415926535897931, rtb_X_state_0, table,
     ...
     &rtb_Forward_length_final, &seg_direction, &head_err,
  ...
  for (ix = 0; ix < rtDW.SFunction_DIMS4_h[0]; ix++) {
    if (rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 + ix] == (rtInf)) {
      ...
      b_j = rtb_X[1] - rtb_Gain1 * rtb_X[0];
      rtb_Forward_length_final = rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] *
        5 + ix] - rtb_Gain1;
      oi_xy_data[ix] = (b_j - rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 6 +
                        ix]) / rtb_Forward_length_final;
      oi_xy_data[ix + idx] = (rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 +
        ix] * b_j - rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 6 + ix] *
        rtb_Gain1) / rtb_Forward_length_final;
    }
  }

  for (idx = 0; idx < oi_xy_size[0]; idx++) {
    OB_enlargescale = oi_xy_data[idx] - rtb_X[0];
    offset_4 = oi_xy_data[idx + oi_xy_size[0]] - rtb_X[1];
  ...
  MM_f(0.017453292519943295 * ajj * 180.0 / 3.1415926535897931, rtb_X_state_0,
       ...
       rtDW.SFunction_DIMS4_h, &rtb_Gain1, &b_j, rtb_Oi_near_l,
       &rtb_Forward_length_final, &seg_direction, &head_err,
       rtb_num_lane_direction_f, &seg_heading);
  ...
  if (rtDW.UnitDelay14_DSTATE == 1.0) {
    ...
    rtb_Forward_length_final = rtb_Gain_p;
  }
      ...
      if (iy == 0) {
        ...
        if (ang_1 >= 0.1) {
          ...
          for (c_ix = 0; c_ix < (int32_T)ang_1; c_ix++) {
            ...
            i = (int32_T)((1.0 + (real_T)c_ix) + forward_length);
          ...
          forward_length += ang_1;
        } else {
          rtDW.Path_RES_0_data[(int32_T)(1.0 + forward_length) - 1] =
            rtb_Forward_Static_Path_x_h[ix];
          rtDW.Path_RES_0_data[(int32_T)(1.0 + forward_length) + 19999] =
            rtb_Forward_Static_Path_y_p[ix];
          forward_length++;
        }

        if (forward_length > target_k - Length_1) {
          iy = 1;
        }
      }
    }
  ...
  if ((xy_ends_POS_size_idx_0 == 0) || (Path_RES_0_size_idx_1 == 0)) {
    ...
    if (1.0 > forward_length) {
      n = 0;
    } else {
      n = (int32_T)forward_length;
    }
  ...
  rtb_final_takeoverlength = rtb_Forward_length_final * rtU.takeover_mag;
  if (!(rtb_final_takeoverlength >= rtU.min_takeoverlength)) {
    rtb_final_takeoverlength = rtU.min_takeoverlength;
  }
  ...
  if ((xy_ends_POS_size_idx_0 == 0) || (Path_RES_0_size_idx_1 == 0)) {
    ...
    if (target_k - Length_1 <= forward_length) {
      ...
      count_1 = forward_length + Length_1;
  ...
  count_1 = 0.0;
  iy = 0;
  Length_1_tmp = rtb_final_takeoverlength - rtb_Forward_length_final;
  ...
  jj = 0;
  forward_length += rtb_Forward_length_final;
  target_k = rtb_X[0];
  y = rtb_X[1];
  ...
  if (Length_1 == 1.0) {
    ...
    offset_3 = forward_length + rtU.Delay_length;
    if (std::sqrt(target_k) > offset_3) {
      Length_1 = 0.0;
    } else {
      ...
      if (std::sqrt(rtb_UnitDelay18) > offset_3) {
        Length_1 = 0.0;
      }
    }
  }
  ...
  if (Length_1 == 1.0) {
    count_1 = 100.0;
    forward_length = rtU.w_off_avoid;
  } else {
  ...
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_e[2],
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint13, y, dist_op_data[0], rtDW.Static_Path_0[(u_data[0] +
             rtDW.SFunction_DIMS4_h[0] * 13) - 1], seg_heading, X13, Y13, XP13,
  ...
  if ((rtU.Freespace_mode == 0.0) || (rtU.Freespace_mode == 2.0)) {
    ...
    for (n = 0; n < (int32_T)rtU.BB_num; n++) {
      ...
      OBXY_EL[(int32_T)(y + -1.0) - 1] = (rtb_UnitDelay18 * OB_enlargescale +
        ...
        (rtb_V_boundingbox[(int32_T)((1.0 + (real_T)n) * 2.0 + -1.0) - 1] -
         rtb_V_boundingbox[idx + 299]) * target_k;
      ...
      OBXY_EL[(int32_T)(y + -1.0) + 99] = ((rtb_V_boundingbox[(int32_T)((1.0 +
        ...
        [(int32_T)((1.0 + (real_T)n) * 2.0 + -1.0) + 99] - rtb_V_boundingbox[idx
        + 199]) * target_k;
      ...
      if (!(Path_col[(ix << 2) + 3] == 1.0)) {
        ...
        while ((!exitg1) && (c_ix < 11)) {
          ...
          while ((!exitg3) && (i <= (int32_T)rtU.BB_num - 1)) {
            ...
            offset_3 = OBXY_EL[b_ix + 199] - OBXY_EL[(int32_T)((1.0 + (real_T)i)
              * 2.0) + 99];
  ...
  for (b_ix = 0; b_ix < 13; b_ix++) {
    rtb_J_out_k[b_ix] = (((((rtb_forward_length_free[b_ix] * 10.0 / target_k *
      ...
      * forward_length) + rtU.W_1[3] * Cobs[b_ix]) + rtU.W_1[4] * Cc_0[b_ix]) +
      rtU.W_1[5] * Clane[b_ix];
  }
  ...
  forward_length = Forward_Static_Path_id_0_data[0] / 180.0;
  d_ix = rtDW.SFunction_DIMS4_h[0];
  for (b_ix = 0; b_ix < d_ix; b_ix++) {
    x_data[b_ix] = (rtb_Forward_Static_Path_id_i[rtDW.SFunction_DIMS4_l - 1] ==
                    rtDW.Static_Path_0[b_ix]);
  ...
  OB_enlargescale = rtDW.Static_Path_0[(rtDW.SFunction_DIMS4_h[0] * 10 +
    v_data_0[0]) - 1] / 4.0;
  target_k = OB_enlargescale * 2.0;
  offset_3 = OB_enlargescale * 3.0;
  offset_4 = OB_enlargescale * 4.0;
  ...
  G2splines_e(ang_1, c, dist_op_data[0], rtDW.Static_Path_0[(u_data[0] +
    rtDW.SFunction_DIMS4_h[0] * 13) - 1], End_x + y * std::cos(forward_length +
    1.5707963267948966), End_y + y * std::sin(forward_length +
  ...
  G2splines_e(x_endpoint2, y_endpoint2, dist_op_data[0], rtDW.Static_Path_0
              ...
              rtb_UnitDelay18 * std::cos(forward_length + 1.5707963267948966),
              End_y + rtb_UnitDelay18 * std::sin(forward_length +
    1.5707963267948966), end_heading_0_data[0], rtDW.Static_Path_0[(u_data_0[0]
  ...
  G2splines_e(x_endpoint3, y_endpoint3, dist_op_data[0], rtDW.Static_Path_0
              [(u_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], End_x +
              offset_4 * std::cos(forward_length + 1.5707963267948966), End_y +
              offset_4 * std::sin(forward_length + 1.5707963267948966),
  ...
  G2splines_e(x_endpoint4, y_endpoint4, dist_op_data[0], rtDW.Static_Path_0
              [(u_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], End_x +
              offset_3 * std::cos(forward_length + 1.5707963267948966), End_y +
              offset_3 * std::sin(forward_length + 1.5707963267948966),
              end_heading_0_data[0], rtDW.Static_Path_0[(u_data_0[0] +
  ...
  G2splines_e(x_endpoint5, y_endpoint5, dist_op_data[0], rtDW.Static_Path_0
              [(u_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], End_x +
              target_k * std::cos(forward_length + 1.5707963267948966), End_y +
              target_k * std::sin(forward_length + 1.5707963267948966),
              end_heading_0_data[0], rtDW.Static_Path_0[(u_data_0[0] +
  ...
  G2splines_e(x_endpoint6, y_endpoint6, dist_op_data[0], rtDW.Static_Path_0
              [(u_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], End_x +
              OB_enlargescale * std::cos(forward_length + 1.5707963267948966),
              End_y + OB_enlargescale * std::sin(forward_length +
    1.5707963267948966), end_heading_0_data[0], rtDW.Static_Path_0[(u_data_0[0]
  ...
  G2splines_e(x_endpoint13, xy_end_point_idx_25, dist_op_data[0],
              ...
              1], End_x + y * std::cos(forward_length - 1.5707963267948966),
              End_y + y * std::sin(forward_length - 1.5707963267948966),
              end_heading_0_data[0], rtDW.Static_Path_0[(u_data_0[0] +
  ...
  if ((rtU.Freespace_mode == 0.0) || (rtU.Freespace_mode == 2.0)) {
    ...
    for (n = 0; n < (int32_T)rtU.BB_num; n++) {
      ...
      forward_length = rtb_V_boundingbox[(int32_T)((1.0 + (real_T)n) * 2.0) - 1]
        - rtb_V_boundingbox[i + 299];
      target_k = rtU.OB_enlarge / std::sqrt(End_y * End_y + forward_length *
        forward_length);
      OBXY_EL[(int32_T)(y + -1.0) - 1] = (rtb_UnitDelay18 * OB_enlargescale +
        rtb_V_boundingbox[(int32_T)((1.0 + (real_T)n) * 2.0 + -1.0) - 1]) +
        End_y * target_k;
      OBXY_EL[(int32_T)y - 1] = (offset_3 * OB_enlargescale + rtb_V_boundingbox
        [(int32_T)((1.0 + (real_T)n) * 2.0) - 1]) + forward_length * target_k;
      OBXY_EL[(int32_T)(y + -1.0) + 99] = ((rtb_V_boundingbox[(int32_T)((1.0 +
        (real_T)n) * 2.0 + -1.0) + 99] - rtb_V_boundingbox[(int32_T)((1.0 +
        (real_T)n) * 2.0 + -1.0) - 1]) * OB_enlargescale + rtb_V_boundingbox
        [(int32_T)((1.0 + (real_T)n) * 2.0 + -1.0) + 99]) + (rtb_V_boundingbox
  ...
  if (target_k != 0.0) {
    ...
    for (ix = 0; ix < 13; ix++) {
      ...
      exp_n(Cc_0);
      for (b_ix = 0; b_ix < 13; b_ix++) {
        Clane[b_ix] = Cc_0[b_ix] / ang_1 * Cobslane_0[b_ix];
      }
  ...
  for (ix = 0; ix < 13; ix++) {
    ...
    if (rtb_U_c_l[ix] == 1.0) {
      ...
      if (Cobs[ix] == 1.0) {
        ...
        forward_length = 2.0 - Cobs[ix];
      }

      forward_length = forward_length * rtU.w_fs + Cc_0[ix];
    } else {
      offset_3 = rtb_forward_length_free_o[ix];
      if (rtb_U_c_l[ix] == 1.0) {
        forward_length = 0.0;
      } else {
        forward_length = 3.0 - rtb_U_c_l[ix];
      }

      forward_length = forward_length * rtU.w_fs + rtb_safety_level_all_p[ix];
    }

    if (offset_3 > rtb_final_takeoverlength) {
      forward_length = 0.0;
    }

    Cobs_0[ix] = offset_3;
    Clane[ix] = forward_length;

    // End of MATLAB Function: '<S2>/J_fsc_design'

    // MATLAB Function: '<S2>/Fianl_Path_Decision'
    rtb_J_out_k[ix] = (rtb_J_out_k[ix] + offset[ix]) + forward_length;
  }
  ...
  if (idx == 0) {
    rtb_final_takeoverlength = rtb_J_out_k[0];
    idx = 1;
  } else {
    rtb_final_takeoverlength = rtb_J_out_k[idx - 1];
    for (i = idx; i + 1 < 14; i++) {
      if (rtb_final_takeoverlength > rtb_J_out_k[i]) {
        rtb_final_takeoverlength = rtb_J_out_k[i];
        idx = i + 1;
      }
    }
  }

  forward_length = std::abs(rtDW.UnitDelay11_DSTATE - rtb_final_takeoverlength);
  ang_1 = 0.0;
  if (rtU.Path_flag == 1.0) {
    if ((rtU.Freespace_mode == 0.0) || (rtU.Freespace_mode == 2.0)) {
      if (rtb_final_takeoverlength >= rtU.W_1[3]) {
        forward_length = rtDW.UnitDelay7_DSTATE;
      } else if ((forward_length < rtU.J_minvalue_diff_min) &&
    ...
    } else if (rtb_final_takeoverlength >= rtU.w_fs) {
      forward_length = rtDW.UnitDelay7_DSTATE;
    } else if ((forward_length < rtU.J_minvalue_diff_min) &&
               (rtDW.UnitDelay13_DSTATE < rtU.J_minvalue_index)) {
      forward_length = rtDW.UnitDelay7_DSTATE;
  ...
  b_idx = (int32_T)forward_length;
  c_ix = (int32_T)forward_length;
  ix = (int32_T)forward_length;
  n = (int32_T)forward_length;
  iy = (int32_T)forward_length;
  d_ix = (int32_T)forward_length;
  jj = (int32_T)forward_length;
  xy_ends_POS_size_idx_0 = (int32_T)forward_length;
  Path_RES_0_size_idx_1 = (int32_T)forward_length;
  Path_RES_1_size_idx_0 = (int32_T)forward_length;
  forward_length_0 = (int32_T)forward_length;
  forward_length_1 = (int32_T)forward_length;
  for (i = 0; i < 11; i++) {
    End_x = a[i] * a[i];
    ...
    rtDW.UnitDelay5_DSTATE[i + 11] = ((((rtb_YP_g[(xy_ends_POS_size_idx_0 - 1) *
      ...
      rt_powd_snf(a[i], 3.0)) + rtb_YP_g[(forward_length_0 - 1) * 6 + 4] *
      rt_powd_snf(a[i], 4.0)) + rtb_YP_g[(forward_length_1 - 1) * 6 + 5] *
      rt_powd_snf(a[i], 5.0);
    x[i] = End_x;
  ...
  if (rtb_Gain_p <= seg_heading) {
    ...
    rtb_Gain_p = ((((rtb_XP_i[((int32_T)forward_length - 1) * 6 + 1] * ajj +
                     rtb_XP_i[((int32_T)forward_length - 1) * 6]) + rtb_XP_i
                    [((int32_T)forward_length - 1) * 6 + 2] * (ajj * ajj)) +
                   rtb_XP_i[((int32_T)forward_length - 1) * 6 + 3] * rt_powd_snf
                   (ajj, 3.0)) + rtb_XP_i[((int32_T)forward_length - 1) * 6 + 4]
                  * rt_powd_snf(ajj, 4.0)) + rtb_XP_i[((int32_T)forward_length -
      1) * 6 + 5] * rt_powd_snf(ajj, 5.0);
    ajj = ((((rtb_YP_g[((int32_T)forward_length - 1) * 6 + 1] * ajj + rtb_YP_g
              [((int32_T)forward_length - 1) * 6]) + rtb_YP_g[((int32_T)
              forward_length - 1) * 6 + 2] * (ajj * ajj)) + rtb_YP_g[((int32_T)
             forward_length - 1) * 6 + 3] * rt_powd_snf(ajj, 3.0)) + rtb_YP_g
           [((int32_T)forward_length - 1) * 6 + 4] * rt_powd_snf(ajj, 4.0)) +
      rtb_YP_g[((int32_T)forward_length - 1) * 6 + 5] * rt_powd_snf(ajj, 5.0);
  } else if ((rtb_Gain_p > seg_heading) && (rtb_Gain_p <= seg_heading +
              total_length)) {
    ajj = (rtb_Gain_p - seg_heading) / total_length;
    seg_heading = ajj * ajj;
    rtb_Gain_p = ((((rtb_XP[((int32_T)forward_length - 1) * 6 + 1] * ajj +
                     rtb_XP[((int32_T)forward_length - 1) * 6]) + rtb_XP
                    [((int32_T)forward_length - 1) * 6 + 2] * seg_heading) +
                   rtb_XP[((int32_T)forward_length - 1) * 6 + 3] * rt_powd_snf
                   (ajj, 3.0)) + rtb_XP[((int32_T)forward_length - 1) * 6 + 4] *
                  rt_powd_snf(ajj, 4.0)) + rtb_XP[((int32_T)forward_length - 1) *
      6 + 5] * rt_powd_snf(ajj, 5.0);
    ajj = ((((rtb_YP[((int32_T)forward_length - 1) * 6 + 1] * ajj + rtb_YP
              [((int32_T)forward_length - 1) * 6]) + rtb_YP[((int32_T)
              forward_length - 1) * 6 + 2] * seg_heading) + rtb_YP[((int32_T)
             forward_length - 1) * 6 + 3] * rt_powd_snf(ajj, 3.0)) + rtb_YP
           [((int32_T)forward_length - 1) * 6 + 4] * rt_powd_snf(ajj, 4.0)) +
      rtb_YP[((int32_T)forward_length - 1) * 6 + 5] * rt_powd_snf(ajj, 5.0);
  } else {
    rtb_Gain_p = ((((rtb_XP[((int32_T)forward_length - 1) * 6 + 1] + rtb_XP
                     [((int32_T)forward_length - 1) * 6]) + rtb_XP[((int32_T)
      forward_length - 1) * 6 + 2]) + rtb_XP[((int32_T)forward_length - 1) * 6 +
                   3]) + rtb_XP[((int32_T)forward_length - 1) * 6 + 4]) +
      rtb_XP[((int32_T)forward_length - 1) * 6 + 5];
    ajj = ((((rtb_YP[((int32_T)forward_length - 1) * 6 + 1] + rtb_YP[((int32_T)
               forward_length - 1) * 6]) + rtb_YP[((int32_T)forward_length - 1) *
             6 + 2]) + rtb_YP[((int32_T)forward_length - 1) * 6 + 3]) + rtb_YP
           [((int32_T)forward_length - 1) * 6 + 4]) + rtb_YP[((int32_T)
      forward_length - 1) * 6 + 5];
  }
  ...
  rtY.J_finalind = forward_length;

  // Outport: '<Root>/forward_length_free' incorporates:
  //   MATLAB Function: '<S2>/Fianl_Path_Decision'

  rtY.forward_length_free = Cobs_0[(int32_T)forward_length - 1];
  ...
  for (b_ix = 0; b_ix < 11; b_ix++) {
    ...
    rtDW.UnitDelay6_DSTATE[b_ix + 11] = ((((rtb_YP[(xy_ends_POS_size_idx_0 - 1) *
      ...
      Y2[b_ix]) + rtb_YP[(forward_length_0 - 1) * 6 + 4] * K2[b_ix]) + rtb_YP
      [(forward_length_1 - 1) * 6 + 5] * K_12[b_ix];
  }
  ...
  rtDW.UnitDelay7_DSTATE = forward_length;

  // Update for UnitDelay: '<S2>/Unit Delay11' incorporates:
  //   MATLAB Function: '<S2>/Fianl_Path_Decision'

  rtDW.UnitDelay11_DSTATE = rtb_final_takeoverlength;
