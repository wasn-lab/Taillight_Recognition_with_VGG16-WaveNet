...
int main(int argc, char **argv)
{
	...
	OB_enlarge = 0.3;
	if (ros::param::get(ros::this_node::getName()+"/OB_enlarge", OB_enlarge));
	min_takeoverlength = 15;
	if (ros::param::get(ros::this_node::getName()+"/min_takeoverlength", min_takeoverlength));
	Delay_length = 7/3;
	if (ros::param::get(ros::this_node::getName()+"/Delay_length", Delay_length));
