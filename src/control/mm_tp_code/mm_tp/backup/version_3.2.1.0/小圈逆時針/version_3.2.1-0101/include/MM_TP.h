...
typedef struct {
  emxArray_real_T_118 path_out1;       // '<S2>/Final_Static_Path'
  real_T path_2[118];                  // '<S13>/Dijkstra'
  ...
  real_T Static_Path_ends_POS_data[944];
  ...
  real_T Forward_Static_Path_0_data[2714];
  real_T path[13924];
  real_T Static_Path_0[2714];          // '<S2>/Final_Static_Path'
...
typedef struct {
  ...
  real_T Constant3_Value[354];

  // Expression: segments
  //  Referenced by: '<S2>/Constant5'

  real_T Constant5_Value[354];
...
class MM_DPP_1ModelClass {
 ...
 private:
  ...
  void merge(int32_T idx[118], real_T x[118], int32_T offset, int32_T np,
             int32_T nq, int32_T iwork[118], real_T xwork[118]);
  void sort(real_T x[118], int32_T idx[118]);
  void rel_dist_xy(const real_T ref_xy[2], const real_T pt_xy[236], real_T dist
                   [118]);
  real_T rel_dist_xy_c(const real_T ref_xy[2], const real_T pt_xy[2]);
  void MM(real_T heading, const real_T X_pos[2], const real_T oi_xy[236], const
          real_T dist_op[118], const real_T Map_data[2714], real_T *seg_id_near,
