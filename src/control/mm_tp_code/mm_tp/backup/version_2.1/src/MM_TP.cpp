...
// C/C++ source code generated on : Tue Sep 24 14:37:31 2019
//
...
void MM_DPP_1ModelClass::step()
{
  ...
  for (shortest_distance_tmp = 0; shortest_distance_tmp < 5;
       shortest_distance_tmp++) {
    rtb_Gain1 = rtb_X_AUG[shortest_distance_tmp] - rtb_X[shortest_distance_tmp];
    rtb_UnitDelay34[shortest_distance_tmp] = rtb_Gain1;
    temp_dia[shortest_distance_tmp] = rtb_Gain1;
  }
  ...
  for (i = 0; i < 10; i++) {
    for (shortest_distance_tmp = 0; shortest_distance_tmp < 5;
         shortest_distance_tmp++) {
      rtb_Gain1 = rtb_X_AUG[(i + 1) * 5 + shortest_distance_tmp] -
    ...
    if (n <= shortest_distance_tmp) {
      ...
      for (i = 0; i < 4; i++) {
        ...
        rtb_V_boundingbox[((int32_T)end_heading + 100 * i) - 1] =
          (rtU.BB_all_XY[((int32_T)(end_heading + -1.0) + 100 * i) - 1] * b_j +
  ...
  for (i = 0; i < 188; i++) {
    if (rtConstP.pooled2[940 + i] == (rtInf)) {
      ...
      rtb_Gain1 = -1.0 / rtConstP.pooled2[940 + i];
      b_j = rtb_X[1] - rtb_Gain1 * rtb_X[0];
      table_tmp = rtConstP.pooled2[940 + i] - rtb_Gain1;
      table[i] = (b_j - rtConstP.pooled2[1128 + i]) / table_tmp;
      table[188 + i] = (rtConstP.pooled2[940 + i] * b_j - rtConstP.pooled2[1128
                        + i] * rtb_Gain1) / table_tmp;
    }
  ...
  for (i = 0; i < rtDW.SFunction_DIMS4_h[0]; i++) {
    if (rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 + i] == (rtInf)) {
      ...
      rtb_Gain1 = -1.0 / rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 + i];
      b_j = rtb_X[1] - rtb_Gain1 * rtb_X[0];
      table_tmp = rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 + i] -
        rtb_Gain1;
      oi_xy_data[i] = (b_j - rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 6 +
                       i]) / table_tmp;
      oi_xy_data[i + idx] = (rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 5 +
        i] * b_j - rtDW.Static_Path_0[rtDW.SFunction_DIMS4_h[0] * 6 + i] *
        rtb_Gain1) / table_tmp;
    }
  }
  ...
  MM_f(0.017453292519943295 * ajj * 180.0 / 3.1415926535897931, rtb_X_state_0,
       oi_xy_data, oi_xy_size, dist_op_data, &b_colj, rtDW.Static_Path_0,
      ...
      if (n == 0) {
        ...
        if (ang_1 >= 0.1) {
          ...
          for (b_colj = 0; b_colj < (int32_T)ang_1; b_colj++) {
            ...
            b_idx = (int32_T)((1.0 + (real_T)b_colj) + count);
  ...
  if (rtDW.SFunction_DIMS2_a - 2 >= 1) {
    for (i = 1; i - 1 <= rtDW.SFunction_DIMS2_a - 3; i++) {
      if (n == 0) {
        offset_3 = rtb_Forward_Static_Path_x_h[i + 1] -
          rtb_Forward_Static_Path_x_h[i];
        x_0 = rtb_Forward_Static_Path_y_p[i + 1] - rtb_Forward_Static_Path_y_p[i];
  ...
  for (i = 0; i < rtDW.SFunction_DIMS4_f; i++) {
    d_ix = rtDW.SFunction_DIMS4_h[0];
    for (iy = 0; iy < d_ix; iy++) {
      x_data[iy] = (rtb_Forward_Static_Path_id_l[i] == rtDW.Static_Path_0[iy]);
    }
      ...
      if (offset_2 <= Length_1) {
        ...
        if (offset_2 >= Length_1) {
          ...
          if (offset_2 <= Length_1) {
            ...
            if (end_heading > head_err) {
              end_heading = head_err;
            } else {
              if (rtIsNaN(end_heading) && (!rtIsNaN(head_err))) {
                end_heading = head_err;
              }
            }
  ...
  if (Length_1 == 1.0) {
    ...
    if (std::sqrt(end_heading) > forward_length + 3.0) {
      Length_1 = 0.0;
    }
  }
  ...
  rtb_TmpSignalConversionAtSFun_0 = 0.017453292519943295 * ajj;
  ...
  x_endpoint3 = x_endpoint6 * offset_4 + table_tmp;
  ...
  y_endpoint8 = end_heading * x_0 + head_err;
  x_endpoint9 = x_endpoint13 * offset_2 + table_tmp;
  y_endpoint9 = end_heading * offset_2 + head_err;
  x_endpoint10 = x_endpoint13 * offset_3 + table_tmp;
  y_endpoint10 = end_heading * offset_3 + head_err;
  x_endpoint11 = x_endpoint13 * offset_4 + table_tmp;
  y_endpoint11 = end_heading * offset_4 + head_err;
  x_endpoint12 = x_endpoint13 * offset_5 + table_tmp;
  y_endpoint12 = end_heading * offset_5 + head_err;
  x_endpoint13 = x_endpoint13 * offset_6 + table_tmp;
  offset_6 = end_heading * offset_6 + head_err;
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            ...
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, x,
            b_Path_dis_data, XP1, YP1, K1_0, K_11, &rtb_J_out_d[0]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint2, y_endpoint2, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X2,
            Y2, XP2, YP2, K2, K_12, &rtb_J_out_d[1]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint3, y_endpoint3, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X3,
            Y3, XP3, YP3, K3, K_13, &rtb_J_out_d[2]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint4, y_endpoint4, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X4,
            Y4, XP4, YP4, K4, K_14, &rtb_J_out_d[3]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint5, y_endpoint5, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X5,
            Y5, XP5, YP5, K5, K_15, &rtb_J_out_d[4]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint6, y_endpoint6, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X6,
            Y6, XP6, YP6, K6, K_16, &rtb_J_out_d[5]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13], table_tmp,
            head_err, dist_op_data[0], rtDW.Static_Path_0[(q_data[0] +
  ...
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            ...
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X8,
            Y8, XP8, YP8, K8, K_18, &rtb_J_out_d[7]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint9, y_endpoint9, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X9,
            Y9, XP9, YP9, K9, K_19, &rtb_J_out_d[8]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint10, y_endpoint10, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X10,
            Y10, XP10, YP10, K10, K_110, &rtb_J_out_d[9]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint11, y_endpoint11, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X11,
            Y11, XP11, YP11, K11, K_111, &rtb_J_out_d[10]);
  G2splines(rtb_X[0], rtb_X[1], rtb_TmpSignalConversionAtSFun_0,
            rtDW.Static_Path_0[idx + rtDW.SFunction_DIMS4_h[0] * 13],
            x_endpoint12, y_endpoint12, dist_op_data[0], rtDW.Static_Path_0
            [(q_data[0] + rtDW.SFunction_DIMS4_h[0] * 13) - 1], rtb_Gain_p, X12,
  ...
  for (iy = 0; iy < 143; iy++) {
    ...
    offset_2 = 1.1 * -x_0 + X_2[iy];
    Path_vehFLX[iy] = offset_2 + 1.4000000000000001 * end_heading;
    offset_3 = 1.1 * end_heading + Y[iy];
    Path_vehFLY[iy] = offset_3 + 1.4000000000000001 * x_0;
    offset_4 = X_2[iy] - 1.1 * -x_0;
    Path_vehFRX[iy] = offset_4 + 1.4000000000000001 * end_heading;
    offset_5 = Y[iy] - 1.1 * end_heading;
    Path_vehFRY[iy] = offset_5 + 1.4000000000000001 * x_0;
    Path_vehRLX[iy] = offset_2 - 5.6000000000000005 * end_heading;
    Path_vehRLY[iy] = offset_3 - 5.6000000000000005 * x_0;
    Path_vehRRX[iy] = offset_4 - 5.6000000000000005 * end_heading;
    Path_vehRRY[iy] = offset_5 - 5.6000000000000005 * x_0;
  ...
  for (iy = 0; iy < 13; iy++) {
    rtb_J_out_d[iy] = (((((rtb_J_out_d[iy] / rtb_Gain_p * 0.5 + Path_col_0[iy] *
  ...
  G2splines_e(x_endpoint1, y_endpoint1, dist_op_data[0], rtDW.Static_Path_0
    ...
    rtDW.SFunction_DIMS4_h[0] * 13) - 1], count, x, b_Path_dis_data, XP1, YP1,
              K1_0, K_11, &offset[0]);
  ...
  G2splines_e(x_endpoint6, y_endpoint6, dist_op_data[0], rtDW.Static_Path_0
              ...
              - 1], count, X6, Y6, XP6, YP6, K1_0, K_11, &offset[5]);
  G2splines_e(table_tmp, head_err, dist_op_data[0], rtDW.Static_Path_0[(q_data[0]
  ...
  G2splines_e(x_endpoint8, y_endpoint8, dist_op_data[0], rtDW.Static_Path_0
              ...
              std::sin(end_heading - 1.5707963267948966), end_heading_0_data[0],
              rtDW.Static_Path_0[(q_data_0[0] + rtDW.SFunction_DIMS4_h[0] * 13)
              - 1], count, X8, Y8, XP8, YP8, K1_0, K_11, &offset[7]);
  ...
  for (i = 0; i < 11; i++) {
    ...
    rtDW.UnitDelay5_DSTATE[i] = ((((rtb_XP_i[shortest_distance_tmp] * a[i] +
      rtb_XP_i[6 * b_idx]) + rtb_XP_i[d_idx] * ang_1) + rtb_XP_i[iy] *
    ...
    rtDW.UnitDelay5_DSTATE[i + 11] = ((((rtb_YP_g[shortest_distance_tmp] * a[i]
      + rtb_YP_g[6 * b_idx]) + rtb_YP_g[d_idx] * ang_1) + rtb_YP_g[iy] *
  ...
  rtb_Gain_p -= rtb_X[0];
  ajj -= rtb_X[1];
  count = std::sin(-rtb_TmpSignalConversionAtSFun_0);
  ang_1 = std::cos(-rtb_TmpSignalConversionAtSFun_0);
