...
namespace object_map
{
  ...
  {
    private_node_handle_.param<std::string>("sensor_frame", sensor_frame_, "base_link");
    ...
    private_node_handle_.param<double>("grid_length_x", grid_length_x_, 50);
    private_node_handle_.param<double>("grid_length_y", grid_length_y_, 30);
    private_node_handle_.param<double>("grid_position_x", grid_position_x_, 10);
