...
void LaneSelectNode::initForROS()
{
  ...
  sub3_ = nh_.subscribe("veh_info", 1, &LaneSelectNode::callbackFromVehInfo, this);
...
{
  std::cout << "is_current_pose_subscribed_ : " << int(is_current_pose_subscribed_) << std::endl;
  std::cout << "is_lane_array_subscribed_ : " << int(is_lane_array_subscribed_) << std::endl;
  std::cout << "is_current_velocity_subscribed_ : " << int(is_current_velocity_subscribed_) << std::endl;
...
void LaneSelectNode::callbackFromLaneArray(const autoware_msgs::LaneArrayConstPtr &msg)
{
  ...
  std::cout << "current_lane_idx_ : " << current_lane_idx_ << std::endl;
...
void LaneSelectNode::callbackFromVehInfo(const msgs::VehInfoConstPtr &msg)
{
  current_velocity_.header.frame_id = "base_link";
  current_velocity_.twist.linear.x = msg->ego_speed;
  is_current_velocity_subscribed_ = true;
